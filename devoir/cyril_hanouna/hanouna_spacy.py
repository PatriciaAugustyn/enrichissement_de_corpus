...
with open("cyril_hanouna.txt", 'r') as fichier:
    test = fichier.read()
...
with open("resultat_spacy_hanouna.txt", 'w') as resultat_fichier:
...
print("Les résultats ont été enregistrés dans le fichier 'resultat_spacy_hanouna.txt'.")
